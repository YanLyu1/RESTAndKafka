...
public class RedisDaoImpl<T> implements RedisDao<T> {
	...
	public T getHash(String input) {
		return valueOperations.get(input + ConstantsConfiguration.HASH_MARK);
	}

	@SuppressWarnings("unchecked")
	public void putValue(String key, Object value) {
		valueOperations.set(key, (T) value);
		valueOperations.set(key + ConstantsConfiguration.HASH_MARK, (T) String.valueOf(System.currentTimeMillis()));
	}
